<div class="navbar navbar-default navbar-fixed-top header-highlight">
    <div class="navbar-header admin_header ">
        <a class="navbar-brand" style="margin-left: 24px;" href="{{action('MainController@index')}}">
            <img src="{{asset('public/logo/wms_logo.png')}}" alt=""></a>
    ...
    <div class="navbar-collapse collapse" id="navbar-mobile">
        ...
        <ul class="nav navbar-nav navbar-right">
            <li class="active"><a href="#" title="">Welcome <strong class="text-info">{{isset(Auth::user()->name) ? Auth::user()->name : 'User name'}}</strong></a></li>
